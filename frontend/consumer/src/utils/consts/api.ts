...
export const FRONTEND_API_PATH = {
  ...
  MEMBERS: FRONTEND_BASE_PATH + API_SUB_PATH.MEMBERS,
  LOGIN: FRONTEND_BASE_PATH + API_SUB_PATH.LOGIN,
} as const;
...
export const BACKEND_API_PATH = {
  ...
  MEMBERS: BACKEND_BASE_PATH + API_SUB_PATH.MEMBERS,
  LOGIN: BACKEND_BASE_PATH + API_SUB_PATH.LOGIN,
} as const;
